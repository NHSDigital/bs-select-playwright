...
class ScreeningLocationListPage():
    ...
    def __init__(self, page : Page) -> None:
        ...
        self.add_screening_location_btn_on_popup = page.locator("#addButtonInAddLocationPopupText")
        self.cancel_add_screening_location_btn = page.locator("#cancelButtonInAddLocationPopup")
        ...
        self.amend_screening_location_btn = page.locator("#amendButtonInAmendLocationPopupText")
        self.cancel_amend_location_btn = page.locator("#cancelButtonInAmendLocationPopup")
        ...
        self.default_screening_location_dropdown = page.locator("//select[@id='defaultLocation']")
        self.default_screening_unit_dropdown = page.locator("//select[@id='defaultUnit']")
    ...
    def enter_screening_location_name(self, location_name:str) -> ScreeningLocationListPage:
    ...
    def enter_screening_location_filter_txtbox(self, location_name:str) -> ScreeningLocationListPage:
    ...
    def enter_amend_screening_location_name(self, amend_name:str) -> ScreeningLocationListPage:
    ...
    def click_create_screening_cohort_by_gp_practice_btn(self) -> ScreeningLocationListPage:
        self.create_screening_cohort_by_gp_practice_btn.click()
        return self
    
    def enter_screening_cohort_name_txtbox(self, cohort_name:str) -> ScreeningLocationListPage:
        self.screening_cohort_name_txtbox.fill(cohort_name)
        return self
        
    def select_default_screening_location_dropdown(self, location_name:str) -> ScreeningLocationListPage:
        self.default_screening_location_dropdown.select_option(location_name)
        return self
        
    def select_default_screening_unit_dropdown(self, unit_name:str) -> ScreeningLocationListPage:
    ...
    def create_location_if_not_exists(self, location_name: str):
        ...
        try:
            self.page.wait_for_selector("p#error_locationNameText", timeout=3000)  # Adjust timeout as needed
            if "Name is already in use by another location" in self.error_message_locator.inner_text():
