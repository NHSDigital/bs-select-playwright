...
class NiRiSpBatchPage():
    ...
    def __init__(self, page : Page) -> None:  
        ...
        self.include_specified_practices_radio_btn = page.locator("#include_specified_practices")
        self.include_specified_practice_groups_radio_btn = page.locator("#include_specified_practice_groups")
        self.include_specified_outcodes_radio_btn = page.locator("#include_specified_outcodes")
        self.include_specified_outcode_groups_radio_btn = page.locator("#include_specified_outcode_groups")
        self.excluded_gp_practices_filter = page.locator("#gpPracticeSelection div.box1 input.filter")
        self.gp_practices_select_move_single_arrow = page.locator("#gpPracticeSelection div.box1 button.move")
        self.outcode_select_move_single_arrow = page.locator("#outcodeSelection div.box1 button.move")
        self.excluded_outcode_filter = page.locator("#outcodeSelection div.box1 input.filter")
        self.excluded_gp_practice_groups_arrow = page.locator("#gpPracticeGroupSelection div.box1 button.move")
        self.excluded_outcode_groups_arrow = page.locator("#outcodeGroupSelection div.box1 button.move")
        self.excluded_gp_practices_list  = page.locator("select#bootstrap-duallistbox-nonselected-list_selectedGpPracticeCodes")
        self.excluded_outcode_list = page.locator("select#bootstrap-duallistbox-nonselected-list_selectedOutcodes")
        self.excluded_gp_practice_groups  = page.locator('select#bootstrap-duallistbox-nonselected-list_selectedGpPracticeGroups')
        self.excluded_outcode_groups = page.locator("select#bootstrap-duallistbox-nonselected-list_selectedOutcodeGroups")
        self.batch_title = page.locator("input#title")
        self.bso_batch_id_filter_text_box = page.locator("#batchIdFilter input[type='text']")
        self.specify_by_gp_practice_group_radio_btn = page.locator("#include_specified_practice_groups")
        self.specify_by_outcode_group_radio_btn = page.locator("#include_specified_outcode_groups")
    ...
    def enter_include_year_of_birth_from(self, year_of_birth_from:str) -> NiRiSpBatchPage:
    ...
    def enter_include_month_of_birth_to(self, month_of_birth_to:str) -> NiRiSpBatchPage:
    ...
    def assert_entered_bso_batch_id_and_filterd_row_value(self, bso_batch_id:str) -> NiRiSpBatchPage:
        self.bso_batch_id_filter_text_box.fill(bso_batch_id)
        self.page.wait_for_timeout(3000)
        first_row_second_cell_value = self.page.locator("//tbody/tr[1]/td[2]").text_content()
    ...
    def search_by_bso_batch_id_and_batch_title(self, bso_batch_id:str, batch_title:str) -> NiRiSpBatchPage:
        self.bso_batch_id_filter_text_box.fill(bso_batch_id)
    ...
    def assert_select_date_cell_value_is_not_null(self, cell_value: str) -> NiRiSpBatchPage:
        self.page.wait_for_timeout(2000)
    ...
    def assert_selected_cell_value_is_not_null(self, cell_value:str) -> NiRiSpBatchPage:
        self.page.wait_for_timeout(2000)
        selected_cell_value = self.page.locator("//tbody/tr[1]/td[7]").text_content()
    ...
    def assert_rejected_cell_value_is_not_null(self, cell_value:str) -> NiRiSpBatchPage:
        self.page.wait_for_timeout(2000)
        rejected_cell_value = self.page.locator("//tbody/tr[1]/td[8]").text_content()
    ...
    def enter_year_range_and_count(self, from_year: str, to_year: str) -> NiRiSpBatchPage:
