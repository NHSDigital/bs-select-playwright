...
class ScreeningUnitListPage():
    ...
    def __init__(self, page : Page) -> None:
        ...
        self.add_screening_unit_btn_on_pop_up_window = page.locator("#addButtonInAddUnitPopup")
        self.unit_type_inactive_radio_btn = page.locator("//input[@id='statusText' and @type='radio' and @value='INACTIVE']")
        self.unit_type_active_radio_btn = page.locator("//input[@id='statusText' and @type='radio' and @value='ACTIVE']")
        ...
        self.no_matching_records_found_msg = page.locator("//td[text()='No matching records found']")
    ...
    def enter_screening_unit_name_txt_box(self, unit_name: dict ) -> ScreeningUnitListPage:
    ...
    def select_unit_status_radio_btn(self, field_value: str) -> ScreeningUnitListPage:
        self.page.wait_for_selector(f"//input[@id='statusText' and @type='radio' and @value='{field_value}']").check()
        return self

    def select_unit_type_radio_btn(self, field_value: str) -> ScreeningUnitListPage:
        self.page.wait_for_selector(f"//input[@id='unitTypeText' and @type='radio' and @value='{field_value}']").check()
        return self
    
    def select_amend_unit_status_radio_btn(self, field_value: str) -> ScreeningUnitListPage:
        self.page.wait_for_selector(f"//input[@id='statusAmendText' and @type='radio' and @value='{field_value}']").check()
        return self
        # value="INACTIVE"
        
    def select_amend_unit_type_radio_btn(self, field_value: str) -> ScreeningUnitListPage:
        self.page.wait_for_selector(f"//input[@id='unitTypeAmendText' and @type='radio' and @value='{field_value}']").check()
        return self
        # value="STATIC"
    ...
    def verify_unit_has_no_matching_records_available_in_the_table(self, unit_name:str) -> ScreeningUnitListPage:
    ...
    def get_day_appointment_value(self) -> ScreeningUnitListPage:
        ...
        return {day: self.page.get_by_role("textbox", name=day).input_value() for day in days}

    def enter_usual_number_of_appontments_text_box(self, unit_data: dict) -> ScreeningUnitListPage:
        if "mon" in unit_data: 
    ...
    def add_screening_unit(self, unit_data: dict, unit_type: str = "MOBILE", unit_status: str = "ACTIVE"):
    ...
    def amend_screening_unit(self, unit_data: dict, unit_type: str = "MOBILE", unit_status: str = "ACTIVE") -> None:
    ...
    def enter_amend_usual_number_of_appontments_text_box(self, unit_data: dict) -> ScreeningUnitListPage:
        if "mon" in unit_data: 
            self.page.locator("//input[@id='mondaySlotsAmendText']").fill(unit_data["mon"])
        if "tue" in unit_data: 
            self.page.locator("//input[@id='tuesdaySlotsAmendText']").fill(unit_data["tue"])
        if "wed" in unit_data: 
            self.page.locator("//input[@id='wednesdaySlotsAmendText']").fill(unit_data["wed"])
        if "thu" in unit_data: 
            self.page.locator("//input[@id='thursdaySlotsAmendText']").fill(unit_data["thu"])
        if "fri" in unit_data: 
            self.page.locator("//input[@id='fridaySlotsAmendText']").fill(unit_data["fri"])
        if "sat" in unit_data: 
            self.page.locator("//input[@id='saturdaySlotsAmendText']").fill(unit_data["sat"])
        if "sun" in unit_data: 
            self.page.locator("//input[@id='sundaySlotsAmendText']").fill(unit_data["sun"])
        return self