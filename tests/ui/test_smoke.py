...
def test_parameters(page: Page) -> None:
    ...
    expect(page.get_by_role("heading")).to_contain_text("Monthly Failsafe Report Parameters")
...
def test_failsafe_reports(page: Page) -> None:
    ...
    """
    MainMenuPage(page).select_menu_option("Failsafe Reports", "Batch Analysis Report List")
...
def test_round_planning(page: Page) -> None:
    ...
    """
    MainMenuPage(page).select_menu_option("Round Planning", "Current and Next Visit List")
