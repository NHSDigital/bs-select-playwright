...
# TC-1 
@pytest.mark.ni
def test_ni_bso_user_cannot_create_ri_sp_batch_when_yob_parameter_not_set(page : Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    ...
    ScreenshotTool(page).take_screenshot("user_cannot_create_ri_sp_batch_when_yob_parameter_not_set")

# TC-2.1
@pytest.mark.ni
def test_eng_bso_user_cannot_create_ri_sp_batch_by_year_of_birth(page: Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    ...
    ScreenshotTool(page).take_screenshot("eng_bso_user_cannot_create_ri_sp_batch_by_yob")

# TC-2.2
@pytest.mark.ni
def test_ni_bso_user_is_able_to_create_ri_sp_batch_by_year_of_birth(page: Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    ...
    ScreenshotTool(page).take_screenshot("ni_bso_user_able_to_create_ri_sp_batch_by_yob")
...
# TC-3.1
@pytest.mark.ni
def test_ni_bso_batch_id_not_unique_warning(page : Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    ...
    MainMenuPage(page).select_menu_option("Batch Management", "Create RI/SP Batch")
    ni_ri_sp_batch_page.assert_page_header("Create RI/SP Batch by Year of Birth")
    ni_ri_sp_batch_page.validate_batch_id_error(batch_id="PMA999582G", expected_error="This Batch ID already exists on the system.")
    ScreenshotTool(page).take_screenshot("batch_id_already_exists_on_the_system")

# TC-3.2
@pytest.mark.ni
def test_ni_bso_batch_id_invalid_format_warning(page : Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    """This test verifies that a BSS NI BSO user sees appropriate warnings 
    ...
    MainMenuPage(page).select_menu_option("Batch Management", "Create RI/SP Batch")
    ni_ri_sp_batch_page.assert_page_header("Create RI/SP Batch by Year of Birth")
    ni_ri_sp_batch_page.validate_batch_id_error(batch_id="123INVALID", expected_error="Invalid format for BSO Batch ID")
    ScreenshotTool(page).take_screenshot("batch_id_invalid_format_warning")    

# TC-3.3
@pytest.mark.ni
def test_ni_bso_batch_id_check_digit_warning(page : Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    """This test verifies that a BSS NI BSO user sees appropriate warnings 
    ...
    MainMenuPage(page).select_menu_option("Batch Management", "Create RI/SP Batch")
    ni_ri_sp_batch_page.assert_page_header("Create RI/SP Batch by Year of Birth")
    ni_ri_sp_batch_page.validate_batch_id_error(batch_id="PMA9168656", expected_error="Invalid format for BSO Batch ID")
    ScreenshotTool(page).take_screenshot("batch_id_incorrect_check_digit_warning")

# TC-4.1
@pytest.mark.ni
def test_ni_date_for_selection_today_shows_warning(page : Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
...
# TC-4.2
@pytest.mark.ni
def test_ni_date_for_selection_in_past_shows_warning(page : Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    ...
    ni_ri_sp_batch_page.click_count_button() 
    ni_ri_sp_batch_page.assert_text_visible("Date for Selection must be in the future")
    ScreenshotTool(page).take_screenshot("batch_id_date_for_selection_must_be_in_the_future_warning")

# TC-5.1
@pytest.mark.ni   
def test_ni_bso_user_receives_warning_for_invalid_yob_range_1954_1975(page: Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    ...
    ni_ri_sp_batch_page.assert_text_visible("Earliest Birth Year must be between 1955 and 1975")
    ScreenshotTool(page).take_screenshot("Earliest_warning_for_invalid_yob_range_1954_1975")

# TC-5.2
@pytest.mark.ni   
def test_ni_bso_user_receives_warning_for_invalid_yob_range_1954_1974(page: Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    ...
    ni_ri_sp_batch_page.assert_text_visible("Earliest Birth Year must be between 1955 and 1975")
    ScreenshotTool(page).take_screenshot("Earliest_warning_for_invalid_yob_range_1954_1974")

# TC-6.1
@pytest.mark.ni  
def test_ni_bso_user_receives_warning_for_invalid_yob_range_1955_1976(page: Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    ...
    ni_ri_sp_batch_page.assert_text_visible("Latest Birth Year must be between 1955 and 1975")
    ScreenshotTool(page).take_screenshot("Latest_warning_for_invalid_yob_range_1955_1976")

# TC-6.2
@pytest.mark.ni  
def test_ni_bso_user_receives_warning_for_invalid_yob_range_1956_1976(page: Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    ...
    ni_ri_sp_batch_page.assert_text_visible("Latest Birth Year must be between 1955 and 1975")
    ScreenshotTool(page).take_screenshot("Latest_warning_for_invalid_yob_range_1956_1976")

# TC-7
@pytest.mark.ni
@pytest.mark.nitest
def test_ni_bso_user_receives_warning_for_invalid_yob_range_1955_1954(page: Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    ...
    ni_ri_sp_batch_page.assert_text_visible("Earliest Birth Year must not be after the Latest Birth Year")
    ni_ri_sp_batch_page.assert_text_visible("Latest Birth Year must be between 1955 and 1975")
    ScreenshotTool(page).take_screenshot("warning_for_invalid_yob_range_1955_1954")

# TC-8
@pytest.mark.ni
def test_ni_bso_user_receives_warning_for_invalid_month_of_birth_range(page: Page, ni_ri_sp_batch_page : NiRiSpBatchPage) -> None:
    ...
    ni_ri_sp_batch_page.click_count_button() 
    ni_ri_sp_batch_page.assert_text_visible("Latest Birth Month must be between 1 and 12")
