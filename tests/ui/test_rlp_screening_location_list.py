...
def test_paging_of_screening_location_list(page : Page, rlp_location_list_page : ScreeningLocationListPage, db_util) -> None:
    """
...
#### Test_04
@pytest.mark.locationlist
def test_add_screening_location(page : Page, rlp_location_list_page : ScreeningLocationListPage) -> None:
    """
...
@pytest.mark.locationlist 
def test_cancel_screening_location(page : Page, rlp_location_list_page : ScreeningLocationListPage) -> None:
    """
...
#### Test_05
@pytest.mark.locationlist 
def test_default_screening_location_values(page : Page, rlp_location_list_page : ScreeningLocationListPage) -> None:
    """
...
def test_create_location_valid_data_positive(page : Page, rlp_location_list_page : ScreeningLocationListPage, input_length) -> None:
    """
...
@pytest.mark.parametrize("invalid_data, expected_message", 
                         [("$%&@", "Name contains invalid characters"), ("cd", "The Name you entered is too short"), 
                          ("     ", "Name must be populated"), ("Aldi - Caldecott County Retail Park","Name is already in use by another location")])       
def test_create_location_invalid_data_negative(page : Page, rlp_location_list_page : ScreeningLocationListPage, invalid_data, expected_message) -> None:  
    """
...
#### Test_07
@pytest.mark.locationlist  
def test_check_availability_of_locations_different_user_same_bso(page : Page, rlp_location_list_page : ScreeningLocationListPage, context) -> None:
    """
    ...
    expect(page.get_by_text("Name is already in use by another location")).to_be_visible()
    
#### Test_08
@pytest.mark.locationlist     
def test_check_availability_of_locations_different_user_different_bso(page : Page, rlp_location_list_page : ScreeningLocationListPage, context) -> None:
    """
...
@pytest.mark.locationlist
@pytest.mark.parametrize("input_length",[3,100])
def test_amend_screening_location(page : Page, rlp_location_list_page : ScreeningLocationListPage, input_length) -> None: 
    """
    ...
    expect(page.locator("#amendButtonInAmendLocationPopupText")).to_be_visible() # Test 9 verification 
...
@pytest.mark.parametrize("invalid_data, expected_message", 
                         [("$%&@", "Name contains invalid characters"), ("cd", "The Name you entered is too short"), 
                          ("     ", "Name must be populated"), ("Aldi - Caldecott County Retail Park","Name is already in use by another location")])      
def test_invalid_amend_screening_location(page : Page, rlp_location_list_page : ScreeningLocationListPage, invalid_data, expected_message) -> None:  
    """
...
## Test_12
@pytest.mark.locationlist
def test_amend_screening_location_availabale_for_other_user_within_same_bso(page : Page, rlp_location_list_page : ScreeningLocationListPage, context) -> None:  
    """
...
## Test_13
@pytest.mark.locationlist   
def test_location_linked_to_multiple_cohorts(page : Page, rlp_cohort_list_page : CohortListPage, context) -> None:
    """
