...
def ceased_page(page: Page) -> CeasedUnceasedPage:
    MainMenuPage(page).select_menu_option("Monitoring Reports", "Ceased/Unceased Subject List")
...
def test_ceased_both_date_added_to_BSO(page: Page, ceased_page: CeasedUnceasedPage) -> None:
    """ 
    ...
    expect(page.locator("#columnHeaderNhsNumber").nth(1)).to_have_attribute("aria-sort","ascending")
...
def test_ceased_both_born(page: Page, ceased_page: CeasedUnceasedPage) -> None:
    ...
    expect(page.locator("#columnHeaderNhsNumber").nth(2)).to_have_attribute("aria-sort","ascending")
...
def test_ceased_both_done_age_today(page: Page, ceased_page: CeasedUnceasedPage) -> None:
    """ 
...
def test_ceased_both_done_all_age_today(page: Page, ceased_page: CeasedUnceasedPage) -> None:
    """ 
...
def test_ceased_both_date_ceased(page: Page, ceased_page: CeasedUnceasedPage) -> None:
    ...
    expect(page.locator("#columnHeaderDateCeased")).to_have_attribute("aria-sort","ascending")
...
def test_ceased_both_date_unceased(page: Page, ceased_page: CeasedUnceasedPage) -> None:
    ...
    expect(page.locator("#columnHeaderDateUnceased")).to_have_attribute("aria-sort","ascending")
