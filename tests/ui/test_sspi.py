...
from pages.monitoring_reports.sspi_update_warnings_action import SSPIUpdateWarningsActionPage
from pages.monitoring_reports.sspi_update_warnings_information import SSPIUpdateWarningsInformationPage
...
def action_page(page: Page) -> SSPIUpdateWarningsActionPage:
    MainMenuPage(page).select_menu_option("Monitoring Reports", "SSPI Update Warnings - Action")
...
def information_page(page: Page) -> SSPIUpdateWarningsInformationPage:
    MainMenuPage(page).select_menu_option("Monitoring Reports", "SSPI Update Warnings - Information")
...
def test_sspi_update_warnings_action_csv_download(page: Page, action_page: SSPIUpdateWarningsActionPage) -> None:
    """ 
...
def test_sspi_update_warnings_action_done(page: Page, action_page: SSPIUpdateWarningsActionPage) -> None:
    """ 
...
def test_sspi_update_warnings_action_nhs_number(page: Page, action_page: SSPIUpdateWarningsActionPage) -> None:
    """ 
...
def test_sspi_update_warnings_action_family_name(page: Page, action_page: SSPIUpdateWarningsActionPage) -> None:
    """ 
...
def test_sspi_update_warnings_action_first_name(page: Page, action_page: SSPIUpdateWarningsActionPage) -> None:
    """ 
...
def test_sspi_update_warnings_action_age(page: Page, action_page: SSPIUpdateWarningsActionPage) -> None:
    """ 
...
def test_sspi_update_warnings_action_received(page: Page, action_page: SSPIUpdateWarningsActionPage) -> None:
    """ 
    Select the sorting Received on the SSPI Update Warnings Action report
    """
    action_page.sort_received()
    expect(page.locator("#columnHeaderReceived")).to_have_attribute("aria-sort","ascending")
    ScreenshotTool(page).take_screenshot("sspi_update_warnings_action_received")

def test_sspi_update_warnings_action_event(page: Page, action_page: SSPIUpdateWarningsActionPage) -> None:
    """
...
def test_sspi_update_warnings_action_warning(page: Page, action_page: SSPIUpdateWarningsActionPage) -> None:
    """
...
def test_sspi_update_warnings_action_add_info(page: Page, action_page: SSPIUpdateWarningsActionPage) -> None:
    """ 
    Select the sorting Add Information on the SSPI Update Warnings Action report
    """
    action_page.sort_add_info()
    expect(page.locator("#columnHeaderAdditionalInfo")).to_have_attribute("aria-sort","ascending")
    ScreenshotTool(page).take_screenshot("sspi_update_warnings_action_add_info")

def test_sspi_update_warnings_information_csv_download(page: Page, information_page: SSPIUpdateWarningsInformationPage) -> None:
    """ 
...
def test_sspi_update_warnings_information_done(page: Page, information_page: SSPIUpdateWarningsInformationPage) -> None:
    """ 
...
def test_sspi_update_warnings_information_nhs_number(page: Page, information_page: SSPIUpdateWarningsInformationPage) -> None:
    """
    ...
    expect(page.locator(information_page.TABLE_FIRST_NHS_NUMBER)).to_have_text(nhs_number)
    ScreenshotTool(page).take_screenshot("sspi_update_warnings_information_nhs_number")

def test_sspi_update_warnings_information_family_name(page: Page, information_page: SSPIUpdateWarningsInformationPage) -> None:
    """ 
    ...
    expect(page.locator(information_page.TABLE_FIRST_FAMILY_NAME)).to_have_text(family_name)
    ScreenshotTool(page).take_screenshot("sspi_update_warnings_information_family_name")

def test_sspi_update_warnings_information_first_name(page: Page, information_page: SSPIUpdateWarningsInformationPage) -> None:
    """ 
    ...
    expect(page.locator(information_page.TABLE_FIRST_FIRST_NAME)).to_have_text(first_name)
    ScreenshotTool(page).take_screenshot("sspi_update_warnings_information_first_name")

def test_sspi_update_warnings_information_age(page: Page, information_page: SSPIUpdateWarningsInformationPage) -> None:
    """ 
...
def test_sspi_update_warnings_information_received(page: Page, information_page: SSPIUpdateWarningsInformationPage) -> None:
    """ 
...
def test_sspi_update_warnings_information_event(page: Page, information_page: SSPIUpdateWarningsInformationPage) -> None:
    """
...
def test_sspi_update_warnings_information_warning(page: Page, information_page: SSPIUpdateWarningsInformationPage) -> None:
    """ 
...
def test_sspi_update_warnings_information_add_info(page: Page, information_page: SSPIUpdateWarningsInformationPage) -> None:
    """ 
