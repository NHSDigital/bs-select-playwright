...
def test_gp_practice_search_national_BS1(api_national_user_session: BrowserContext) -> None:
    """ 
...
def test_gp_practice_search_included_in_group_yes(api_bso_user_session: BrowserContext) -> None:
    """ 
...
def test_gp_practice_search_included_in_group_no(api_bso_user_session: BrowserContext) -> None:
    """ 
