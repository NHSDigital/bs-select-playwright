...
def test_gp_practices_assigned_to_bso_search_all(api_bso_user_session: BrowserContext) -> None:
    """ 
...
def test_gp_practices_assigned_to_bso_search_practice(api_bso_user_session: BrowserContext) -> None:
    """ 
...
def test_gp_practices_assigned_to_bso_search_name(api_bso_user_session: BrowserContext) -> None:
    """ 
