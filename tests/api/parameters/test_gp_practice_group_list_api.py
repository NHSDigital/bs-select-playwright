...
def test_gp_practice_group_list_search_all(api_bso_user_session: BrowserContext) -> None:
    """ 
...
def test_gp_practice_group_list_search_BS1(api_bso_user_session: BrowserContext) -> None:
    """ 
